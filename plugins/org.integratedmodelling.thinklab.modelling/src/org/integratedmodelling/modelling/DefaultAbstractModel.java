...
public abstract class DefaultAbstractModel implements IModel {
	...
	/*
	 * not null if this model has been generated by applying a scenario to another model.
	 */
	...
	protected IModel applyScenarioInternal(Scenario scenario, Session session) throws ThinklabException {
		...
		/*
		 * give the sucker our ID so it will work in references, and store the scenario
		 * to constrain queries as needed.
		 */
		if (ret != null) {
			ret.id = id;
