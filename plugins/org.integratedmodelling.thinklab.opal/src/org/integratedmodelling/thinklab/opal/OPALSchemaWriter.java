...
public class OPALSchemaWriter {

    public OPALSchemaWriter() {
        super();
     ...
     * @param writer
     */
    public void writeXMLSchema(PrintWriter writer) {
     ...
     * @param writer
     */
    public void writeDTD(PrintWriter writer) {
