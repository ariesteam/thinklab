/**
 * OPALDocumentationGenerator.java
 * ----------------------------------------------------------------------------------
 * 
...
public class OPALDocumentationGenerator {

    public OPALDocumentationGenerator() {
        super();
     ...
     * @param writer
     */
    public void writeDocumentation(PrintWriter writer) {
