 ...
 */
package org.integratedmodelling.thinklab.kbox.sql.postgres;
...
import org.integratedmodelling.thinklab.kbox.sql.SQL;
...
public class PostgreSQLServer extends SQLServer {
	...
	public static boolean haveDatabase(String database) throws ThinklabException {
		...
		String user = SQL.get().getDefaultUser();
		String pswd = SQL.get().getDefaultPassword();
		String host = SQL.get().getDefaultHost();
