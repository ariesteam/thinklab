...
//		super(protocol, SQL.get().createSQLServer(serverURL, properties),
//				properties);
//		this.uri = uri;
//	}
//
...
//	}
//	
//	public ISemanticObject getObjectFromID(String id, ISession session)
//			throws ThinklabException {
//
//		IList list = this.retrieveObjectAsList(id);
//		return new SemanticObject(new Semantics(list, Thinklab.get()));
//	}
//
//	public ISemanticObject getObjectFromID(String id, ISession session,
...
//	}
//
//	public long storeObject(ISemanticObject object)
//			throws ThinklabException {
//
//		String ret = null;
//		Semantics list = object.getSemantics();
//		Pair<String, String> sql = storeInstanceSQL(list);
//
...
//	 */
////	@Override
//	public String storeObject(ISemanticObject object, String id, Map<String, ISemanticLiteral> metadata,
...
//
//	
//	public long storeObject(ISemanticObject object) throws ThinklabException {
//
//		long ret = 0l;
//
