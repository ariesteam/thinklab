...
public class Value implements IValue {
	...
	/**
	 * @category Operator functions, used to bridge to embedded languages and for convenience
	 * @param v
	 * @return
	 * @throws ThinklabValueConversionException
	 * @throws ThinklabInappropriateOperationException
	 */
    final public IValue plus(IValue v) throws ThinklabValueConversionException, ThinklabInappropriateOperationException {
    	return op("+", v);
    }
	 ...
	 * @throws ThinklabInappropriateOperationException
	 */
    final public IValue minus(IValue v) throws ThinklabValueConversionException, ThinklabInappropriateOperationException {
    	return op("-", v);
    }
	/**
	 * @category Operator functions, used to bridge to embedded languages and for convenience
	 ...
	 * @throws ThinklabInappropriateOperationException
	 */
    final public IValue multiply(IValue v) throws ThinklabValueConversionException, ThinklabInappropriateOperationException {
    	return op("*", v);
    }
	/**
	 * @category Operator functions, used to bridge to embedded languages and for convenience
	 ...
	 * @throws ThinklabInappropriateOperationException
	 */
    final public IValue divide(IValue v) throws ThinklabValueConversionException, ThinklabInappropriateOperationException {
    	return op("/", v);
    }
	/**
	 * @category Operator functions, used to bridge to embedded languages and for convenience
	 ...
	 * @throws ThinklabInappropriateOperationException
	 */
    final public IValue or(IValue v) throws ThinklabValueConversionException, ThinklabInappropriateOperationException {
    	return op("|", v);
    }
	/**
	 * @category Operator functions, used to bridge to embedded languages and for convenience
	 ...
	 * @throws ThinklabInappropriateOperationException
	 */
    final public IValue and(IValue v) throws ThinklabValueConversionException, ThinklabInappropriateOperationException {
    	return op("&", v);
    }
	/**
	 * @category Operator functions, used to bridge to embedded languages and for convenience
	 ...
	 * @throws ThinklabInappropriateOperationException
	 */
    final public IValue next() throws ThinklabValueConversionException, ThinklabInappropriateOperationException {
    	return op("++", (IValue[])null);
    }
	 ...
	 * @throws ThinklabInappropriateOperationException
	 */
    final public IValue previous() throws ThinklabValueConversionException, ThinklabInappropriateOperationException {
    	return op("--", (IValue[])null);
    }
	/**
	 * @category Operator functions, used to bridge to embedded languages and for convenience
	 ...
	 * @throws ThinklabInappropriateOperationException
	 */
    final public IValue leftShift(IValue v) throws ThinklabValueConversionException, ThinklabInappropriateOperationException {
    	return op("<<", v);
    }


	public int compareTo(IValue other) throws ThinklabInappropriateOperationException, ThinklabValueConversionException {
		throw new ThinklabInappropriateOperationException("comparison unimplemented on " + concept + " literals");
	}


	public IValue getAt(int index) throws ThinklabInappropriateOperationException {
		throw new ThinklabInappropriateOperationException("array operations unimplemented on " + concept + " literals");
	}


	public IValue putAt(IValue value, int index) throws ThinklabInappropriateOperationException {
		throw new ThinklabInappropriateOperationException("array operations unimplemented on " + concept + " literals");
	}


	public boolean equals(IValue other) {
		return concept.equals(other.getConcept());
	}
