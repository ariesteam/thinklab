...
public class SetupKM extends TestCase {

	public ISession theSession = null;
	public KnowledgeManager theKnowledgeManager = null;
		  ...
		  try {      	
	 	       ...
	 	       theKnowledgeManager = 
		    	   new KnowledgeManager(new FileKnowledgeRepository(), 
		    			   		        new APIOnlyKnowledgeInterface(null));

	 	    	theKnowledgeManager.initialize();				
	 	    	theSession = theKnowledgeManager.requestNewSession();
