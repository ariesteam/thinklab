...
public class AllTests {
	...
	public static Test suite() {
		TestSuite suite = new TestSuite(
				"Test for org.integratedmodelling.ima.test.core.impl.protege");
		//$JUnit-BEGIN$
		suite.addTestSuite(FileKnowledgeRepositoryTest.class);
		suite.addTestSuite(OntologyTest.class);
		suite.addTestSuite(ConceptTest.class);
		suite.addTestSuite(InstanceTest.class);
		suite.addTestSuite(PropertyTest.class);
		suite.addTestSuite(ThinklabLocalRepositoryTest.class);
		//$JUnit-END$
		return suite;
	}
