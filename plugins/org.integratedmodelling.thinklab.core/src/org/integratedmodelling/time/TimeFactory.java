...
import org.integratedmodelling.time.extents.RegularTemporalGrid;
import org.integratedmodelling.time.extents.TemporalLocation;
...
public class TimeFactory {
	...
	public static IExtent parseTimeTopology(String s) throws ThinklabException {
		...
		IExtent ret = null;
		if (res == null) {
			ret = new TemporalLocation(start);
		} else {
			ret = 
				new RegularTemporalGrid(
						start.getTimeData(), 
						end.getTimeData(), 
