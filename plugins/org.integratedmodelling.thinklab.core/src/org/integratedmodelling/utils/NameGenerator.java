...
public class NameGenerator {
	...
	static public synchronized String newName() {
		...
		long newidx = index++;
		return "GEN__" + nn + "_" + Long.toString(newidx);
	}
	
	/**
	 * Generate a unique string starting with a specified prefix after the GEN__ standard prefix.
	 * @param prefix
	 * @return
	 */
	static public synchronized String newName(String prefix) {
		return "GEN__" + prefix + newName();
	}
	
	/**
	 * Check if the passed name has been generated by this class. Easily fooled - just start with
	 * "GEN__". Oh gosh I told you.
	 * 
	 * @param name
	 * @return
	 */
	static public boolean isGenerated(String name) {
		return name.startsWith("GEN__");
	}
