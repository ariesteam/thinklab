...
import org.integratedmodelling.thinklab.exceptions.ThinklabCircularDependencyException;
...
public class ModelMap {
	...
	public static class FormObjectEntry extends Entry {
		...
		public IModelObject form;

		public FormObjectEntry(IModelObject form) {
			this.form = form;
		}
		 ...
		 */
		public DefaultDirectedGraph<IModelObject, DepEdge> getDependencies() {
			
			DefaultDirectedGraph<IModelObject, DepEdge> ret = 
				new DefaultDirectedGraph<IModelObject, DepEdge>(DepEdge.class);
		...
		private void getDependenciesInternal(
				DefaultDirectedGraph<IModelObject, DepEdge> mep) {
	...
	public static class NamespaceEntry extends Entry {
		...
		private INamespace ontologyDescriptor;
		...
		public Collection<IModelObject> getAllModelObjects() {
			ArrayList<IModelObject> ret = new ArrayList<IModelObject>();
		...
		public void defineOntology(INamespace ret) {
	...
	private static void checkName(String name) throws ThinklabValidationException {
	...
	public static DefaultDirectedGraph<IModelObject, DepEdge> getDependencies(String object) 
		throws ThinklabException {
	...
	public static void releaseNamespace(String namespace) {
		...
		for (IModelObject m : ns.getAllModelObjects()) {	
	...
	public static Collection<IModelObject> listNamespace(String ns) {
		NamespaceEntry nse = (NamespaceEntry) getNamespace(ns);
		return nse.getAllModelObjects();
	}

	public static IModelObject getModelForm(String model) throws ThinklabException {
