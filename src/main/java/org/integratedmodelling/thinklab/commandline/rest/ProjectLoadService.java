...
import org.integratedmodelling.thinklab.modelling.ModelManager.Resolver;
 ...
 * 
 */
@RESTResourceHandler(id="load", description="load local project",  arguments="project")
public class ProjectLoadService extends DefaultRESTHandler {
