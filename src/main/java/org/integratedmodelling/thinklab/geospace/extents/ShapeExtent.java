 ...
 *
 */
public class ShapeExtent extends ArealExtent implements IStorageMetadataProvider {
	...
	/*
	 * TODO make this the only storage of features. It's an iterator too, so it should work
	 * in retrieving the states although we need indexed random access too.
	 */
